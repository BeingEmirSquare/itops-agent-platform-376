...
```bash
git clone https://github.com/BeingEmirSquare/itops-agent-platform-376.git
cd itops-agent-platform-376
npm install
npm start
```
...
[![CI](https://github.com/BeingEmirSquare/itops-agent-platform-376/actions/workflows/ci.yml/badge.svg)](https://github.com/BeingEmirSquare/itops-agent-platform-376/actions/workflows/ci.yml)
[![GitHub release](https://img.shields.io/github/v/release/qinshihu/itops-agent-platform?include_prereleases&sort=semver)]()
...
- [🐛 提交 Bug](https://github.com/BeingEmirSquare/itops-agent-platform-376/issues/new?template=bug_report.yml)
- [💡 提出新功能](https://github.com/BeingEmirSquare/itops-agent-platform-376/issues/new?template=feature_request.yml)
- [📝 改进文档](https://github.com/BeingEmirSquare/itops-agent-platform-376/issues/new?template=docs_update.yml)
- [🔒 报告安全问题](SECURITY.md)
...
<!-- Last updated: 2026-06-06 14:55:05 -->
